...
public class BSBMTests {
	...
	public void BSBMTest1() {
		...
		String testOutput = summarize(1, 1, "weak", "w", "noSaturation", false);
	...
	public void BSBMTest2() {
		...
		String testOutput = summarize(2, 1, "weak", "w", "classical", false);
	...
	public void BSBMTest3() {
		...
		String testOutput = summarize(3, 1, "weak", "w", "shortcut", false);
	...
	public void BSBMTest4() {
		...
		String testOutput = summarize(4, 1, "typedweak", "tw", "noSaturation", false);
	...
	public void BSBMTest5() {
		...
		String testOutput = summarize(5, 1, "typedweak", "tw", "noSaturation", false);
	...
	public void BSBMTest6() {
		...
		String testOutput = summarize(6, 1, "strong", "s", "noSaturation", false);
	...
	public void BSBMTest7() {
		...
		String testOutput = summarize(7, 1, "strong", "s", "classical", false);
	...
	public void BSBMTest8() {
		...
		String testOutput = summarize(8, 1, "strong", "s", "shortcut", false);
	...
	public void BSBMTest9() {
		...
		String testOutput = summarize(9, 1, "typedstrong", "ts", "noSaturation", false);
	...
	public void BSBMTest10() {
		...
		String testOutput = summarize(10, 1, "typedstrong", "ts", "noSaturation", false);
	...
	public void BSBMTest11() {
		...
		String testOutput = summarize(11, 10, "weak", "w", "noSaturation", false);
	...
	public void BSBMTest12() {
		...
		String testOutput = summarize(12, 10, "weak", "w", "classical", false);
	...
	public void BSBMTest13() {
		...
		String testOutput = summarize(13, 10, "weak", "w", "shortcut", false);
	...
	public void BSBMTest14() {
		...
		String testOutput = summarize(14, 10, "typedweak", "tw", "noSaturation", false);
	...
	public void BSBMTest15() {
		...
		String testOutput = summarize(15, 10, "typedweak", "tw", "noSaturation", false);
	...
	public void BSBMTest16() {
		...
		String testOutput = summarize(16, 10, "strong", "s", "noSaturation", false);
	...
	public void BSBMTest17() {
		...
		String testOutput = summarize(17, 10, "strong", "s", "classical", false);
	...
	public void BSBMTest18() {
		...
		String testOutput = summarize(18, 10, "strong", "s", "shortcut", false);
	...
	public void BSBMTest19() {
		...
		String testOutput = summarize(19, 10, "typedstrong", "ts", "noSaturation", false);
	...
	public void BSBMTest20() {
		...
		String testOutput = summarize(20, 10, "typedstrong", "ts", "noSaturation", false);
	...
	public void BSBMTest21() {
		...
		String testOutput = summarize(21, 100, "weak", "w", "noSaturation", false);
	...
	public void BSBMTest22() {
		...
		String testOutput = summarize(22, 100, "weak", "w", "classical", false);
	...
	public void BSBMTest23() {
		...
		String testOutput = summarize(23, 100, "weak", "w", "shortcut", false);
	...
	public void BSBMTest24() {
		...
		String testOutput = summarize(24, 100, "typedweak", "tw", "noSaturation", false);
	...
	public void BSBMTest25() {
		...
		String testOutput = summarize(25, 100, "typedweak", "tw", "noSaturation", false);
	...
	public void BSBMTest26() {
		...
		String testOutput = summarize(26, 100, "strong", "s", "noSaturation", false);
	...
	public void BSBMTest27() {
		...
		String testOutput = summarize(27, 100, "strong", "s", "classical", false);
	...
	public void BSBMTest28() {
		...
		String testOutput = summarize(28, 100, "strong", "s", "shortcut", false);
	...
	public void BSBMTest29() {
		...
		String testOutput = summarize(29, 100, "typedstrong", "ts", "noSaturation", false);
	...
	public void BSBMTest30() {
		...
		String testOutput = summarize(30, 100, "typedstrong", "ts", "noSaturation", false);
	...
	public void BSBMTest31() {
		...
		String testOutput = summarize(31, 1, "2pstrong", "2ps", "noSaturation", false);
	...
	public void BSBMTest32() {
		...
		String testOutput = summarize(32, 1, "2pstrong", "2ps", "classical", false);
	...
	public void BSBMTest33() {
		...
		String testOutput = summarize(33, 1, "2pstrong", "2ps", "shortcut", false);
	...
	public void BSBMTest34() {
		...
		String testOutput = summarize(34, 10, "2pstrong", "2ps", "noSaturation", false);
	...
	public void BSBMTest35() {
		...
		String testOutput = summarize(35, 10, "2pstrong", "2ps", "classical", false);
	...
	public void BSBMTest36() {
		...
		String testOutput = summarize(36, 10, "2pstrong", "2ps", "shortcut", false);
	...
	public void BSBMTest37() {
		...
		String testOutput = summarize(37, 100, "2pstrong", "2ps", "noSaturation", false);
	...
	public void BSBMTest38() {
		...
		String testOutput = summarize(38, 100, "2pstrong", "2ps", "classical", false);
	...
	public void BSBMTest39() {
		...
		String testOutput = summarize(39, 100, "2pstrong", "2ps", "shortcut", false);
	...
	public void BSBMTest40() {
		...
		String testOutput = summarize(40, 1, "onefb", "1fb", "noSaturation", false);
	...
	public void BSBMTest41() {
		...
		String testOutput = summarize(41, 10, "onefb", "1fb", "noSaturation", false);
	...
	public void BSBMTest42() {
		...
		String testOutput = summarize(42, 1, "2pweak", "2pw", "noSaturation", false);
	...
	public void BSBMTest43() {
		...
		String testOutput = summarize(43, 1, "2pweak", "2pw", "classical", false);
	...
	public void BSBMTest44() {
		...
		String testOutput = summarize(44, 1, "2pweak", "2pw", "shortcut", false);
	...
	public void BSBMTest45() {
		...
		String testOutput = summarize(45, 10, "2pweak", "2pw", "noSaturation", false);
	...
	public void BSBMTest46() {
		...
		String testOutput = summarize(46, 10, "2pweak", "2pw", "classical", false);
	...
	public void BSBMTest47() {
		...
		String testOutput = summarize(47, 10, "2pweak", "2pw", "shortcut", false);
	...
	public void BSBMTest48() {
		...
		String testOutput = summarize(48, 100, "2pweak", "2pw", "noSaturation", false);
	...
	public void BSBMTest49() {
		...
		String testOutput = summarize(49, 100, "2pweak", "2pw", "classical", false);
	...
	public void BSBMTest50() {
		...
		String testOutput = summarize(50, 100, "2pweak", "2pw", "shortcut", false);
