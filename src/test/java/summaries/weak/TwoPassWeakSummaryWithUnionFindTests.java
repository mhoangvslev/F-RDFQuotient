...
public class TwoPassWeakSummaryWithUnionFindTests {
	private static final Logger LOGGER = Logger.getLogger(TwoPassWeakSummaryWithUnionFindTests.class.getName());

	public File summarizeUsingTwoPassWeakSummary(int i) {
		LOGGER.setLevel(Level.INFO);
		System.out.println("################################################################################");
		System.out.println("Two-pass Weak summary with Union-Find test " + Integer.toString(i) + " only summarization");
		System.out.println("################################################################################");

		String inputFileName = "src/test/resources/test" + i + "-2pweakunionfind/test-" + i + ".nt";
		String outputFileName = "src/test/resources/test" + i + "-2pweakunionfind/test-" + i + "_2pwuf_noSaturation.nt";
		try {
			String[] argsSum = {"loadAndSummarize", "2pweakunionfind", inputFileName};
			try {
			...
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test " + i + " " + e.toString());
		}
	...
	public File saturateAndSummarizeUsingTwoPassWeakSummary(int i) {
		System.out.println("################################################################################");
		System.out.println("Two-pass Weak summary with Union-Find test " + Integer.toString(i) + " saturation and summarization");
		System.out.println("################################################################################");

		String inputFileName = "src/test/resources/test" + i + "-2pweakunionfind/test-" + i + ".nt";
		String outputFileName = "src/test/resources/test" + i + "-2pweakunionfind/test-" + i + "_2pwuf_classical.nt";
		try {
			String[] argsSum = {"loadWithSaturationAndSummarize", "2pweakunionfind", inputFileName};
			try {
				Builder.main(argsSum);
	...
	public File summarizeThroughShortcutUsingTwoPassWeakSummary(int i) {
		System.out.println("################################################################################");
		System.out.println("Two-pass Weak summary with Union-Find test " + Integer.toString(i) + " summarization through shortcut");
		System.out.println("################################################################################");

		String inputFileName = "src/test/resources/test" + i + "-2pweakunionfind/test-" + i + ".nt";
		String outputFileName = "src/test/resources/test" + i + "-2pweakunionfind/test-" + i + "_2pwuf_shortcut.nt";
		try {
			String[] argsSum = {"loadAndSummarizeUsingShortcut", "2pweakunionfind", inputFileName};
			try {
				Builder.main(argsSum);
	...
	private String expectedOutput(int i, String summarizationTechnique) {
		return "src/test/resources/test" + i + "-2pweakunionfind/test-" + i + "_2pwuf_" + summarizationTechnique + "-reference.nt";
	}
	...
	public void summarizeWeakTest1() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 1", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 1 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest2() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 2", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 2 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest3() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 3", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 3 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest4() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 4", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 4 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest5() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 5", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 5 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest6() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 6", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 6 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest7() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 7", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 7 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest8() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 8", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 8 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest9() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 9", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 9 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest10() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 10", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 10 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest11() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 11", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 11 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest12() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 12", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 12 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest13() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 13", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 13 " + e.toString());
		}
	}
	...
	public void summarizeWeakTest14() {
		...
		try {
			...
			assertTrue("Different summary 2pweakunionfind 14", FileUtils.contentEquals(testOutput, expectedOutput));
		}
		catch (IOException e) {
			throw new IllegalStateException("Unable to open .nt files in 2pweakunionfind test 14 " + e.toString());
		}
	}
